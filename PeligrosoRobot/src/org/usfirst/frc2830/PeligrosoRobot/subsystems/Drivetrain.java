...
public class Drivetrain extends Subsystem {
	 ...
	 * @return
	 */
	public void driveSplitArcade(double throttle, double steering) {

		// robotDrive41.arcadeDrive(throttle, steering);
		// Make sure the values are outside if the deadband
		steering = deadbanded(steering, joystickDeadband);
		throttle = deadbanded(throttle, joystickDeadband);
		double overPower;
		double angularPower;
