...
public class RobotMap {
    ...
    *     
        ...
        frontCamera.setResolution(128, 80);
        frontCamera.setFPS(5);
       // frontCamera.
        UsbCamera rearCamera = CameraServer.getInstance().startAutomaticCapture(1);
        rearCamera.setResolution(128, 80);
        rearCamera.setFPS(5);
        
        CvSink cvSink1 = CameraServer.getInstance().getVideo(frontCamera);
        CvSink cvSink2 = CameraServer.getInstance().getVideo(rearCamera);
        CvSource outputStream = CameraServer.getInstance().putVideo("Switcher", 128, 80);
